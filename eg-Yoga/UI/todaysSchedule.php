<?php
    ...
    $user = new User;
    $schedule = $user->getTodaysScheduleInfomation();
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body class="admintop">
    <div class="w-75 mx-auto">
        <h2 class="py-2">Today's Lesson Schedule</h2>
                ...
                <?php
                    ...
                    echo "<tr>
                        ...
                        if($row["status"] == "waiting"){
                            echo "<td><a class='btn btn-warning btn-sm w-100'>".$row["status"]."</a></td>";
                        }elseif($row["status"] == "going"){
                            echo "<td><a class='btn btn-primary btn-sm text-white w-100'>".$row["status"]."</a></td>";
                        }else{
